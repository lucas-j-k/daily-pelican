...
//Initialize ad code, injecting wordpress variables in from the request object:
function ad_scripts()
{
    global $wp;
    global $post;
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'secondary-menu' => __('Secondary Menu Menu', 'html5blank'), // Secondary Navigation
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Main sidebar across the site', 'html5blank'),
        'id' => 'global-sidebar',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="global-sidebar__heading">',
        'after_title' => '</h3>'
    ));
...
add_action('wp_print_scripts', 'ad_scripts'); // Add Custom Scripts to wp_head
